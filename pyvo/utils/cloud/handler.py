...
def process_json_column(dalProduct, colname='cloud_access'):
...
def process_datalinks(dalProduct):
...
class CloudRecordMixin:
    ...
    def enable_cloud(self):
        ...
        if (hasattr(self._results, 'access_points') and 
